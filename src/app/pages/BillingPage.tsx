        ...
        <div className="space-y-3">
          {!confirmed ? (
            ...
            <>
              ...
              <div className="flex items-center justify-center gap-2 p-3 bg-[#F0FDF4] rounded-[8px] border border-[#BBF7D0]">
                {/* WhatsApp SVG Icon */}
                <svg
                ...
                <span
                  className="font-['DM_Sans'] text-[13px] text-[#16A34A]"
                  style={{ fontWeight: 500 }}
                >
                  WhatsApp bill sent automatically to {selectedCustomer?.name}
                </span>
              </div>
